...
public class DashboardStatisticsService {
    ...
    public DashboardStatisticsResponse getDashboardStatistics() {
        ...
        // Calculate trends
        Double needsReviewTrend = calcTrend(needsReviewToday, needsReviewYesterday);
        Double lowConfidenceTrend = calcTrend(lowConfidenceToday, lowConfidenceYesterday);
        Double inProgressTrend = calcTrend(inProgressToday, inProgressYesterday);
        Double resolvedTodayTrend = calcTrend(resolvedToday, resolvedYesterday);
